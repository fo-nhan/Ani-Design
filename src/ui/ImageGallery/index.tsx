...
const ImageGallery: React.FC<ImageGalleryProps> = ({
  ...
  const loadingImages = React.useCallback(() => {
    ...
    if (images.length === 3) {
      ...
      return (
        <>
          ...
          <div
            className={`${classNameWidth} ${classNameHeight}% ${
              styles.rowImage
            } ${styles[`gap-${gap}`]} ${
              styles[`${classNameHeight}-as-Gallery-gap-${gap}-line-2`]
            }`}
          >
            <View
              src={img2.src}
    ...
    if (images.length === 4) {
      ...
      return (
        <>
          <div
            className={`UI-2ANI-BOX-width-100% UI-2ANI-BOX-height-50% ${
              styles.rowImage
            } ${styles[`gap-${gap}`]} ${
              styles[`UI-2ANI-BOX-height-50-as-Gallery-gap-${gap}-line-2`]
            }`}
          >
            <View
              src={img1.src}
      ...
      <>
        ...
        <div
          className={`${classNameWidth} ${classNameHeight}% ${
            ...
            letter
              ? styles[`${classNameHeight}-as-Gallery-gap-${gap}-line-3`]
              : ""
          }`}
        >
          <View
                  ...
                  <Box
                    ...
                    style={{
                      height: list.wHeight
                        ...
                        : "auto",
                      maxHeight: `${
                        child.height > list.width ? list.width : child.height
                      }px`,
                      minHeight: `${
                        child.height > list.width ? list.width : child.height
                      }px`,
  ...
  return (
    <div
      ref={ref}
      className={`UI-2ANI-css-no-copy ${styles.gallery} ${
        styles[`gap-${gap}`]
      } ${styles[`UI-2ANI-Gallery-padding-${padding}`]}`}
    >
      {renderImages}
    </div>
  );
